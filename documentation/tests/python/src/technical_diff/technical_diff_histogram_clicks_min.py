...
trace_tech_diff = go.Histogram(x=dff['clicks_per_minute'],
                               opacity=0.75,
                               name='Technical Difficulties')

data = [trace_all, trace_tech_diff]
layout = go.Layout(
    title='Histogram of Clicks Per Min',
    xaxis=dict(
...
offline.plot(fig, filename='technical_diff_histogram_clicks_min.html')
